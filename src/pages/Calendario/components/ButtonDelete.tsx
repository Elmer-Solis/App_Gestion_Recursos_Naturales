...
// }
import { useCalendarStore } from "@/store/storeCalendario";
import { useMantenimientoStore } from "@/store/storeCalendarioMant"; // Importar el store de mantenimiento

export function ButtonDeleteCalendar() {
    const { selectedEvent, setSelectedEvent, deleteEvent } = useCalendarStore();
    const { selectedMantenimiento, setSelectedMantenimiento, deleteMantenimiento } = useMantenimientoStore(); // Añadir los mantenimientos
    ...
    const handleClick = () => {
        if (selectedEvent) {
            ...
            deleteMantenimiento(selectedMantenimiento.id);
            setSelectedMantenimiento(null); // Limpiar la selección
        }
    };

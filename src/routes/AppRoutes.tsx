    ...
    <BrowserRouter>
      <Routes>
        <Route element={<MainLayout />}>
          <Route path="/" element={<ProtectedRoute element={<Dashboard />} allowedRoles={['Superadmin', 'Admin', 'Fontanero']} />} index />
          ...
          <Route path="/Expediente" element={<ProtectedRoute element={<Expediente />} allowedRoles={['Superadmin', 'Admin']} />} />
          <Route path="/fin_expediente" element={<ProtectedRoute element={<Fin_expediente />} allowedRoles={['Superadmin', 'Admin']} />} />
          <Route path="/Horas_extras" element={<ProtectedRoute element={<Inicio />} allowedRoles={['Superadmin', 'Admin']} />} />

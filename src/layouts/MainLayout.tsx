...
//             {/* Sidebar visible en escritorio y mobile */}
//             <aside
//                 className={`shadow-md ${isMobileMenuOpen ? "fixed inset-0 z-20" : "hidden md:block"}`}
//             >
...
export default function MainLayout() {
    ...
    return (
        <div className="grid h-screen w-full grid-cols-[auto_1fr]">
            ...
            >
                <Sidebar sidebarOpen={isAsideExpanded || isMobileMenuOpen} setSidebarOpen={toggleAside} closeMobileMenu={() => setIsMobileMenuOpen(false)} />
            </aside>
